...
class NostalgiaForInfinityNext(IStrategy):
    ...
    # Trail 3
    sell_trail_profit_min_4 = DecimalParameter(0.01, 0.12, default=0.02, space='sell', decimals=3, optimize=False, load=True)
    sell_trail_profit_max_4 = DecimalParameter(0.02, 0.1, default=0.08, space='sell', decimals=2, optimize=False, load=True)
    ...
    def custom_sell(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float,
        ...
        if (last_candle is not None):
            ...
            # elif (self.sell_trail_profit_max_4.value > current_profit > self.sell_trail_profit_min_4.value) & (max_profit > (current_profit + self.sell_trail_down_4.value)) & (last_candle['ema_50'] < last_candle['ema_100']):
